...
/// <summary>
/// Provides a mechanism for displaying <see cref="AppoMobi.Maui.Popups.IPopup"/>s based on the underlying view model.
/// </summary>
public interface IPopupService
{
	...
	/// <summary>
	/// Resolves and displays a <see cref="AppoMobi.Maui.Popups.IPopup"/> and <typeparamref name="TViewModel"/> pair that was registered with <c>AddTransientPopup</c>.
	/// </summary>
	/// <remarks>
	/// This method must be called on the UI thread otherwise it will throw an <see cref="InvalidOperationException"/>.
	/// </remarks>
	/// <typeparam name="TViewModel">The type of the view model registered with the <see cref="AppoMobi.Maui.Popups.IPopup"/>.</typeparam>
	/// <exception cref="InvalidOperationException">Thrown if this method is not called on the UI thread.</exception>
	...
	/// <returns>A <see cref="Task"/> that can be awaited to return the result of the <see cref="AppoMobi.Maui.Popups.IPopup"/> once it has been dismissed.</returns>
	/// <exception cref="InvalidOperationException">Thrown if this method is not called on the UI thread.</exception>
