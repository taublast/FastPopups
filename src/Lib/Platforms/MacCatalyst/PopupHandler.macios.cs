...
public partial class PopupHandler : ViewHandler<IPopup, MauiPopupView>
{
	...
	public static void MapOnDismissedByTappingOutsideOfPopup(PopupHandler handler, IPopup view, object? result)
	{
		...
		if (popup.IsViewLoaded && view.CanBeDismissedByTappingOutsideOfPopup)
		{
	...
	{
		handler.PlatformView.Popup?.SetCanBeDismissedByTappingOutsideOfPopup(view);
	}
	...
	{
		handler.PlatformView.Popup?.SetColor(view);
	}
